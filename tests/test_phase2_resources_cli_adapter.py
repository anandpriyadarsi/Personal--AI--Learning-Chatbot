...
def test_fix10_does_not_route_resource_writes_yet(monkeypatch):
    """
    Fix 10 is intentionally read-only routing.  Keep this guard so add/update
    are not accidentally changed before their dedicated Phase 2 write fix.
    """
    fake_store = []
