...
def load_store():
    routed = maybe_load_sqlite_structured_store("multi_course_weekly_plans", MULTI_PLANS_FILE)
...
def save_store(store):
    if maybe_save_sqlite_structured_store("multi_course_weekly_plans", MULTI_PLANS_FILE, store):
        return
