...
Run-Step "[1/7] Tutor 2.1 adaptive + correctness + retrieval + live-fix focused tests" {
...
Write-Host "deterministic math verification/repair, smarter retrieval, topic-shift/follow-up continuity,"
