...
function Stop-Gate {
    ...
    Write-Host ""
    Write-Host "========================================="
    Write-Host " PHASE 3.1 FIX 11 GATE: BLOCKED"
    Write-Host "========================================="
    Write-Host $Message
    exit 1
}
...
$requiredFiles = @(
    ...
    "tests\test_phase3_grades_calendar_importer.py",
    "PHASE3_FIX11_GRADES_CALENDAR_IMPORTER.md"
)

foreach ($path in $requiredFiles) {
    if (-not (Test-Path $path)) {
        Stop-Gate "Required Fix 11 file is missing: $path"
    }
}
...
Run-Step "[1/5] Phase 3.1 Fix 11 grades/calendar importer tests" {
...
Write-Host ""
Write-Host "=========================================="
Write-Host " PHASE 3.1 FIX 11 GATE: PASS"
Write-Host "=========================================="
Write-Host "Verified:"
Write-Host "  - optional grade configuration is imported or reported absent"
Write-Host "  - planning grade scales remain explicitly verified/unverified"
Write-Host "  - course credits and explicit grade evidence resolve safely"
Write-Host "  - assessment deadlines create source-linked calendar events"
