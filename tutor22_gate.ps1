...
Assert-ProtectedHashesUnchanged "[1/8] Tutor 2.2 focused tests"
...
Assert-ProtectedHashesUnchanged "[2/8] Tutor 2.1 regressions"
...
Assert-ProtectedHashesUnchanged "[3/8] Tutor 2.0/web regressions"
...
Assert-ProtectedHashesUnchanged "[4/8] Search/reader/retrieval regressions"
...
Assert-ProtectedHashesUnchanged "[5/8] Complete pytest regression"
...
Assert-ProtectedHashesUnchanged "[6/8] Compile/dependency check"
